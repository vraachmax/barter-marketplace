...
## 2026-09-21: уточнение Максима, обрезка и маленький логотип
...
Подготовлена новая компоновка через статические Next ImageResponse routes:
...
CI и публикация ожидаются. Физический iPhone/старый ярлык не проверены.
Следующий шаг: закончить CI/визуальную сверку, опубликовать, проверить на iPhone.
