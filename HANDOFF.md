...
## 2026-09-26: подгонка отступов, подготовка к проверке

Ветка fix/consistent-screen-spacing от master2e5de9c7, открытых PR на старте нет.
Изменены7 экранов и общий нижний reserve; хаб не менялся.
Исследованы первичные рекомендации Fluent2 layout и Apple design tips.
Сравнение, конкретные размеры и ограничения: docs/SPACING_REVIEW.md.
CI и публикация ещё не подтверждены. Полный production-аудит заблокирован
таймаутом каталога (включая повтор) и незагруженными тарифами в cloud browser.
Новые проверки геометрии идут на изолированных данных, не production-аккаунтах.
Следующий шаг: завершить проверку/выпуск, затем изучить barter_chat_export.txt.
