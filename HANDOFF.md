...
работой нет. Ветка: `fix/ui-01-settings-shared-header`. PR оформляется.
...
Проверки на момент подготовки: чтение исходников и статическая проверка изменений.
Исполнение тестов/сборки пока ожидает CI. Рабочее окружение не запустилось;
