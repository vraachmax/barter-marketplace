      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-sm">
              <li><Link href="/" className="text-[#6b7280] hover:text-[#007AFF] dark:text-zinc-400 dark:hover:text-[#007AFF]">Все объявления</Link></li>
              <li><Link href="/favorites" className="text-[#6b7280] hover:text-[#007AFF] dark:text-zinc-400 dark:hover:text-[#007AFF]">Избранное</Link></li>
              <li><Link href="/messages" className="text-[#6b7280] hover:text-[#007AFF] dark:text-zinc-400 dark:hover:text-[#007AFF]">Сообщения</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-sm">
              <li><Link href="/new" className="text-[#6b7280] hover:text-[#007AFF] dark:text-zinc-400 dark:hover:text-[#007AFF]">Разместить объявление</Link></li>
              <li><Link href="/profile" className="text-[#6b7280] hover:text-[#007AFF] dark:text-zinc-400 dark:hover:text-[#007AFF]">Личный кабинет</Link></li>
              <li><Link href="/profile/settings" className="text-[#6b7280] hover:text-[#007AFF] dark:text-zinc-400 dark:hover:text-[#007AFF]">Настройки</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-8 flex flex-wrap items-center justify-between gap-4 pt-6">
          ...
          <div className="flex items-center gap-3 text-xs text-[#6b7280] dark:text-zinc-500">
            <Link href="/auth" className="hover:text-[#007AFF] dark:hover:text-[#007AFF]">Вход</Link>
            <span>·</span>
            <Link href="/auth?mode=register" className="hover:text-[#007AFF] dark:hover:text-[#007AFF]">Регистрация</Link>
          </div>
        </div>
      </div>
    </footer>
