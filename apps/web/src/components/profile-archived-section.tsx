    ...
    return (
      <div className="overflow-hidden rounded-2xl border border-border bg-card shadow-sm">
        <div className="border-b border-border bg-muted/50 px-6 py-10 text-center md:px-10">
          ...
          <Link
            href="/profile/listings?tab=ACTIVE"
            className="mt-6 inline-flex min-h-13 items-center justify-center rounded-full bg-primary px-5 py-3 text-base font-semibold text-primary-foreground hover:bg-primary-hover"
          >
