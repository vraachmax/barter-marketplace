    ...
    <div className="min-h-screen bg-[#f7f7f7] text-[#1a1a1a] antialiased dark:bg-zinc-950 dark:text-zinc-100">
      ...
      <header className="sticky top-0 z-20 bg-white shadow-[0_1px_4px_rgba(0,0,0,0.08)] backdrop-blur-md dark:bg-zinc-950/95 md:hidden">
        <div className="flex h-14 items-center justify-between px-4">
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-1.5 rounded-lg bg-[#00B4D8] px-3 py-2 text-xs font-semibold text-white transition hover:bg-[#0096b5]"
          >
        ...
        {status === 'need_auth' ? (
          <div className="mx-auto max-w-md py-10">
            <div className="overflow-hidden rounded-lg bg-white dark:bg-zinc-900/80">
              <div className="bg-[#e0f5fb] px-6 py-10 text-center dark:bg-sky-950/40">
                <div className="mx-auto grid h-16 w-16 place-items-center rounded-lg bg-white dark:bg-zinc-900">
                  <Sparkles size={32} strokeWidth={s} className="text-[#00B4D8]" aria-hidden />
                </div>
              ...
              <div className="p-6">
                <Link
                  href="/auth"
                  className="flex h-12 w-full items-center justify-center rounded-lg bg-[#00B4D8] text-sm font-semibold text-white transition hover:bg-[#0096b5]"
                >
            ...
            <main className="min-w-0 space-y-6">
              ...
              <div className="hidden items-start justify-between gap-4 md:flex">
                ...
                <div className="flex shrink-0 flex-wrap justify-end gap-2">
                  <Link
                    href="/"
                    className="inline-flex items-center gap-2 rounded-lg bg-[#00B4D8] px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-[#0096b5]"
                  >
              ...
              <div className="overflow-hidden rounded-lg bg-white dark:bg-zinc-900/80">
                <div className="bg-[#00B4D8] px-5 py-4 text-white">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4">
                  <button
                    ...
                    className={`flex flex-col items-start gap-1 px-4 py-4 text-left transition hover:bg-[#f0f9ff] dark:hover:bg-sky-950/40 ${
                      activeTab === 'ACTIVE' ? 'bg-[#e0f5fb] dark:bg-sky-950/50' : ''
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex flex-col items-start gap-1 px-4 py-4 text-left transition hover:bg-[#f0f9ff] dark:hover:bg-sky-950/40 ${
                      activeTab === 'SOLD' ? 'bg-[#e0f5fb] dark:bg-sky-950/50' : ''
                    }`}
                  >
                ...
                <div className="grid gap-3 p-4 sm:grid-cols-3">
                  <div className="rounded-lg bg-[#f7f7f7] px-4 py-3 dark:bg-zinc-950/50">
                    ...
                    <div className="mt-1 flex items-baseline gap-2">
                      ...
                      <Link href="/profile/settings" className="text-xs font-semibold text-[#00B4D8] hover:underline">
                        Улучшить
                      </Link>
                    </div>
                  </div>
              ...
              {actionItems.length > 0 ? (
                <div className="rounded-lg bg-[#f0fdf9] p-4 dark:bg-emerald-950/30">
                  <div className="mb-3 flex items-center gap-2 text-sm font-bold text-[#1a1a1a] dark:text-zinc-100">
                    <Sparkles size={20} strokeWidth={s} className="text-[#06D6A0]" aria-hidden />
                    Рекомендуем сделать
                  </div>
                ...
                <div className="flex flex-wrap gap-2">
                  <span
                    className={`inline-flex items-center gap-1.5 rounded-full px-3 py-1.5 text-xs font-semibold ${
                      hasActiveSeller
                        ? 'bg-[#f0f9ff] text-[#00B4D8] border border-[#00B4D8]'
