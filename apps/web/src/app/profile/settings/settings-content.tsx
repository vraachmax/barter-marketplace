...
function MobileSettingsToggle({
  ...
  return (
    <div
      ...
      className="flex cursor-pointer items-center justify-between gap-3 py-3.5 px-4 outline-none transition hover:bg-zinc-50 focus-visible:ring-2 focus-visible:ring-sky-500/40 dark:hover:bg-zinc-900/40"
    >
      <div className="flex items-center gap-3 min-w-0">
        <Icon size={18} strokeWidth={stroke} className="shrink-0 text-zinc-600 dark:text-zinc-400" aria-hidden />
          ...
          <>
            ...
            <div className="md:hidden space-y-3 pb-24">
              ...
              <div className="space-y-2">
                <p className="px-1 text-xs font-bold uppercase tracking-wide text-zinc-400 dark:text-zinc-500">
                  Аккаунт
                </p>
                {me?.avatarUrl ? (
                  <div className="flex items-center gap-3 rounded-2xl bg-white p-4 dark:bg-zinc-900/80">
                    <img src={me.avatarUrl} alt="" className="h-12 w-12 rounded-full object-cover" />
                    <div className="min-w-0 flex-1">
                      <div className="text-sm font-semibold text-[#1a1a1a] dark:text-zinc-100 truncate">
                ...
                >
                  ...
                  <span className="flex-1 text-left text-sm font-semibold text-[#1a1a1a] dark:text-zinc-100">Сменить пароль</span>
              ...
              <div className="space-y-2">
                ...
                <div className="rounded-2xl bg-white dark:bg-zinc-900/80 divide-y divide-zinc-100 dark:divide-zinc-800 overflow-hidden">
                  <div className="flex items-center justify-between gap-3 p-4">
                    <div className="flex items-center gap-3 min-w-0">
                      <Bell size={24} strokeWidth={1.5} className="shrink-0 text-[#0088FF]" aria-hidden />
                      <span className="text-sm font-semibold text-[#1a1a1a] dark:text-zinc-100">Push-уведомления</span>
                    </div>
                    <button
                      type="button"
                      role="switch"
                      ...
                      className={`relative h-7 w-12 shrink-0 rounded-full transition ${form.notificationsEnabled ? 'bg-[#0088FF]' : 'bg-zinc-300 dark:bg-zinc-600'}`}
                    >
                      <span className={`absolute top-0.5 left-0.5 h-6 w-6 rounded-full bg-white shadow-sm transition-transform ${form.notificationsEnabled ? 'translate-x-5' : 'translate-x-0'}`} />
                    </button>
                  </div>
                  <div className="flex items-center justify-between gap-3 p-4">
                    <div className="flex items-center gap-3 min-w-0">
                      <Mail size={24} strokeWidth={1.5} className="shrink-0 text-[#0088FF]" aria-hidden />
                      <span className="text-sm font-semibold text-[#1a1a1a] dark:text-zinc-100">Email-рассылка</span>
                    </div>
                    <button
                      type="button"
                      role="switch"
                      ...
                      className={`relative h-7 w-12 shrink-0 rounded-full transition ${form.marketingEnabled ? 'bg-[#0088FF]' : 'bg-zinc-300 dark:bg-zinc-600'}`}
                    >
                      <span className={`absolute top-0.5 left-0.5 h-6 w-6 rounded-full bg-white shadow-sm transition-transform ${form.marketingEnabled ? 'translate-x-5' : 'translate-x-0'}`} />
                    </button>
                  </div>
                  <div className="flex items-center justify-between gap-3 p-4">
                    <div className="flex items-center gap-3 min-w-0">
                      <MessageSquare size={24} strokeWidth={1.5} className="shrink-0 text-[#0088FF]" aria-hidden />
                      <span className="text-sm font-semibold text-[#1a1a1a] dark:text-zinc-100">SMS-уведомления</span>
                    </div>
                    <button
                      type="button"
                      role="switch"
                ...
                <div className="rounded-2xl bg-white dark:bg-zinc-900/80 divide-y divide-zinc-100 dark:divide-zinc-800 overflow-hidden">
                  <div className="flex items-center justify-between gap-3 p-4">
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      <span className="text-sm font-semibold text-[#1a1a1a] dark:text-zinc-100">Показывать телефон</span>
                    </div>
                    <button
                      type="button"
                      role="switch"
                      ...
                      className={`relative h-7 w-12 shrink-0 rounded-full transition ${form.showPhonePublic ? 'bg-[#0088FF]' : 'bg-zinc-300 dark:bg-zinc-600'}`}
                    >
                      <span className={`absolute top-0.5 left-0.5 h-6 w-6 rounded-full bg-white shadow-sm transition-transform ${form.showPhonePublic ? 'translate-x-5' : 'translate-x-0'}`} />
                    </button>
                  </div>
                  <div className="flex items-center justify-between gap-3 p-4">
                    <div className="flex items-center gap-3 min-w-0">
                      <Eye size={24} strokeWidth={1.5} className="shrink-0 text-[#0088FF]" aria-hidden />
                      <span className="text-sm font-semibold text-[#1a1a1a] dark:text-zinc-100">Показывать email</span>
                    </div>
                    <button
                      type="button"
                      role="switch"
                      ...
                      className={`relative h-7 w-12 shrink-0 rounded-full transition ${form.showEmailPublic ? 'bg-[#0088FF]' : 'bg-zinc-300 dark:bg-zinc-600'}`}
                    >
                      <span className={`absolute top-0.5 left-0.5 h-6 w-6 rounded-full bg-white shadow-sm transition-transform ${form.showEmailPublic ? 'translate-x-5' : 'translate-x-0'}`} />
                    </button>
                  </div>
                </div>
              </div>
                ...
                <div className="rounded-2xl bg-white dark:bg-zinc-900/80 divide-y divide-zinc-100 dark:divide-zinc-800 overflow-hidden">
                  <div className="flex items-center justify-between gap-3 p-4">
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      <span className="text-sm font-semibold text-[#1a1a1a] dark:text-zinc-100">Ночной режим</span>
                    </div>
                    <button
                      type="button"
                      role="switch"
                      ...
                      className={`relative h-7 w-12 shrink-0 rounded-full transition ${form.appTheme === 'DARK' ? 'bg-[#0088FF]' : 'bg-zinc-300 dark:bg-zinc-600'}`}
                    >
                      <span className={`absolute top-0.5 left-0.5 h-6 w-6 rounded-full bg-white shadow-sm transition-transform ${form.appTheme === 'DARK' ? 'translate-x-5' : 'translate-x-0'}`} />
                    </button>
                  </div>
                  <div className="flex items-center justify-between gap-3 p-4">
                    <div className="flex items-center gap-3 min-w-0">
                      <Globe size={24} strokeWidth={1.5} className="shrink-0 text-[#0088FF]" aria-hidden />
                      <span className="text-sm font-semibold text-[#1a1a1a] dark:text-zinc-100">Язык</span>
                    </div>
              ...
              {/* DANGER ZONE Section */}
              <div className="space-y-2">
                <p className="px-1 text-xs font-bold uppercase tracking-wide text-red-500 dark:text-red-400">
                  Опасная зона
                </p>
                <button
                  type="button"
                ...
                >
                  <Trash2 size={24} strokeWidth={1.5} className="text-red-500" aria-hidden />
                  <span className="flex-1 text-left text-sm font-semibold text-red-600 dark:text-red-400">Удалить аккаунт</span>
                  <ChevronRight size={20} strokeWidth={1.5} className="text-red-300 dark:text-red-700" aria-hidden />
                </button>
              ...
              {saved ? (
                <div className="flex items-center gap-2 rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm font-medium text-emerald-900 dark:border-emerald-900/50 dark:bg-emerald-950/40 dark:text-emerald-100">
              ...
              <div className="fixed bottom-16 left-0 right-0 z-30 px-4 pb-3 pt-2 bg-gradient-to-t from-zinc-100 via-zinc-100 to-zinc-100/0 dark:from-zinc-950 dark:via-zinc-950 dark:to-zinc-950/0">
                <button
                  type="button"
                  onClick={() => void save()}
                  disabled={busy}
                  className="w-full inline-flex h-12 items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-[#0088FF] to-[#0066DD] px-6 text-sm font-bold text-white shadow-lg shadow-sky-600/25 transition hover:from-sky-700 hover:to-cyan-700 disabled:cursor-not-allowed disabled:opacity-50"
                >
                  {busy ? (
                    <>
                      <span
